        ...
        <div className="p-4 border-t border-sidebar-border">
          ...
          <div className="mt-4 pt-4 border-t border-sidebar-border">
            <p className="text-xs text-center text-muted-foreground">
              ...
              <a href="https://www.instagram.com/aaafdhal/" target="_blank" rel="noopener noreferrer" className="text-primary hover:text-primary/80 font-medium transition-colors">
        ...
        {isMobileMenuOpen && <>
          ...
          duration: 0.3
              ...
              <div className="flex-1 p-4">
                ...
                }} className={`w-full flex items-start gap-3 px-4 py-4 rounded-xl transition-all duration-300 ${isActive ? 'gradient-primary text-white' : 'text-sidebar-foreground hover:bg-sidebar-accent'}`}>
                        <Icon className="w-6 h-6 mt-0.5" />
                        <div className="flex-1 text-left">
                          <span className="font-semibold text-base block">{item.label}</span>
                          <span className={`text-xs mt-1 block ${isActive ? 'text-white/80' : 'text-muted-foreground'}`}>
                            {item.description}
                          </span>
                        </div>
                      </button>;
