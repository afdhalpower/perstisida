    ...
    <>
      ...
      >
        <div className="p-6 border-b border-sidebar-border">
          <div className="flex items-center gap-3 mb-2">
            ...
            <div>
              <h1 className="text-xl font-bold text-sidebar-foreground">PestisidaApp</h1>
              <p className="text-sm text-muted-foreground">Kios Pestisida</p>
            </div>
          </div>
        </div>
        ...
        <div className="p-4 border-t border-sidebar-border">
          ...
          <motion.button
            ...
            className="w-full flex items-center gap-3 px-4 py-3 rounded-xl text-destructive hover:bg-red-50 transition-all duration-300"
          >
      ...
      <div className="lg:hidden fixed top-0 left-0 right-0 h-16 glass-effect border-b border-sidebar-border flex items-center justify-between px-4 z-50">
        <div className="flex items-center gap-3">
          ...
          <h1 className="text-lg font-bold">PestisidaApp</h1>
        </div>
