    ...
    <div className="p-4 lg:p-8">
      ...
      >
        <div className="flex items-center gap-3 mb-6">
          ...
          <div>
            <h1 className="text-4xl font-bold">Sistem Akuntansi</h1>
            <p className="text-lg text-muted-foreground">Kelola keuangan bisnis dengan sistem akuntansi lengkap</p>
          </div>
        </div>
      </motion.div>
          ...
          {sections.map((section, index) => {
            ...
            return (
              <motion.button
                ...
                className={`w-full text-left p-4 rounded-xl transition-all duration-300 hover-lift ${
                  isActive 
