...
export function WidgetLibrary({ onEditWidget }: WidgetLibraryProps) {
  const [searchTerm, setSearchTerm] = useState('');
  const { availableTemplates, addWidget } = useWidgetStore();
              ...
              >
                <div className="flex items-start justify-between">
                  ...
                  <button
                    ...
                    className="p-2 rounded-lg bg-primary text-white opacity-0 group-hover:opacity-100 transition-opacity hover:bg-primary/90"
                  >
