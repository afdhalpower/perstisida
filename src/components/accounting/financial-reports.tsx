...
export function FinancialReports() {
  ...
  return <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-2xl font-bold"><span className="editable-text">Laporan Keuangan</span></h2>
          <p className="text-muted-foreground"><span className="editable-text">Analisis kinerja keuangan perusahaan</span></p>
        </div>
