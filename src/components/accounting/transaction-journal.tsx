  ...
  const journalEntries: JournalEntry[] = [
    {
      ...
      accounts: [
        { account: 'Kas', debit: 2500000, credit: 0 },
        { account: 'Penjualan', debit: 0, credit: 2500000 }
      ]
    },
    {
      id: '2',
      ...
      accounts: [
        { account: 'Biaya Gaji', debit: 1500000, credit: 0 },
    ...
    },
    {
      ...
      accounts: [
        { account: 'Persediaan', debit: 5000000, credit: 0 },
        { account: 'Kas', debit: 0, credit: 3000000 },
        { account: 'Hutang Dagang', debit: 0, credit: 2000000 }
      ]
    },
    {
      id: '4',
      ...
      accounts: [
        { account: 'Biaya Sewa', debit: 2000000, credit: 0 },
        { account: 'Kas', debit: 0, credit: 2000000 }
      ]
    }
  ];
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">Pencatatan jurnal harian</p>
        </div>
        
        <div className="flex items-center gap-3">
          <button
            onClick={() => alert('Export jurnal ke Excel')}
          ...
          <button
            ...
            className="gradient-primary text-white px-4 py-2 rounded-lg font-semibold flex items-center gap-2"
          >
                ...
                <table className="w-full">
                  ...
                  <tfoot>
                    <tr className="border-t-2 border-border font-semibold">
                      ...
                      <td className="py-2 px-3 text-right">Rp {totalDebit.toLocaleString('id-ID')}</td>
                      <td className="py-2 px-3 text-right">Rp {totalCredit.toLocaleString('id-ID')}</td>
                    </tr>
                  </tfoot>
                </table>
              </div>
      ...
      {showForm && (
        <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4">
          <div className="glass-effect rounded-2xl p-6 w-full max-w-2xl">
            <h3 className="text-xl font-semibold mb-4">Tambah Jurnal Transaksi</h3>
            <div className="space-y-4">
