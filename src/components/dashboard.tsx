        ...
        <div className="flex items-center gap-3 mb-2">
          ...
          <div>
            ...
            <p className="text-muted-foreground">
              {format(new Date(), 'EEEE, dd MMMM yyyy', { locale: { code: 'id' } })}
            </p>
          </div>
        </div>
      </motion.div>
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="text-center p-4 rounded-xl bg-gradient-to-br from-blue-50 to-blue-100">
            ...
            <h3 className="font-semibold text-blue-700">Transaksi Baru</h3>
            <p className="text-blue-600 text-sm">Catat penjualan terbaru</p>
          </div>
          ...
          <div className="text-center p-4 rounded-xl bg-gradient-to-br from-purple-50 to-purple-100">
            ...
            <h3 className="font-semibold text-purple-700">Kelola Produk</h3>
            <p className="text-purple-600 text-sm">Update stok dan harga</p>
          </div>
          ...
          <div className="text-center p-4 rounded-xl bg-gradient-to-br from-green-50 to-green-100">
            ...
            <h3 className="font-semibold text-green-700">Laporan</h3>
            <p className="text-green-600 text-sm">Analisis penjualan</p>
          </div>
        </div>
      </motion.div>
    </div>
